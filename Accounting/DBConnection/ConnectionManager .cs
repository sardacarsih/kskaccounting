    ...
    public static class ConnectionManager
    {
        ...
        public static string GetOracleConnection()
        {
            ...
            if (!String.IsNullOrEmpty(settings.Server))
            {
                ...
                {
                    OracleConnString = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=LOCALHOST)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=XXXKEBUN)));User Id=KSK;Password=KSKboss";
                }
                else if (DATA_server == "LOCAL_MSLKEBUN")
                {
                    OracleConnString = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=LOCALHOST)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=XXXKEBUN)));User Id=MSL;Password=MSLboss";
                }
                else if (DATA_server == "LOCAL_FSLKEBUN")
                {
                    OracleConnString = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=LOCALHOST)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=XXXKEBUN)));User Id=FSL;Password=FSLboss";
                }

                else if (DATA_server == "KSKGROUP")
                {
                    OracleConnString = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=10.10.10.41)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=KSKGROUP.GRAHAFAJAR)));User Id=KSKG;Password=KSKGboss2022";
                }
                else if (DATA_server == "FSLGROUP")
                {
                    OracleConnString = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=10.10.10.41)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=FSLGROUP.GRAHAFAJAR)));User Id=FSLG;Password=FSLGboss2022";
                }
                else if (DATA_server == "PAJAK")
                {
                    OracleConnString = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=10.10.10.41)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=PAJAK.GRAHAFAJAR)));User Id=PAJAK;Password=PAJAKboss2022";
                }
