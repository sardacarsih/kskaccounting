...
namespace Accounting.DataLayer
{
    ...
    {
        IQueryable<JurnalKasirHeaderDTO> GetJurnalHeader_Kasir(int p_periode_int, string p_ptlokasi);
        IQueryable<JurnalInventoryHeaderDTO> GetJurnalHeader_Inventory(int p_periode_int, string p_ptlokasi);
        DataTable JurnalKasirDetail_DapperKasir(DateTime p_dari, DateTime p_sampai, string p_ptlokasi, string p_iddata, string p_estate, string p_posted, string p_periode, string p_userid, int p_glyear, int p_glmonth);
        
        IQueryable<JurnalInventoryDetailDTO> GetJurnalDetails_Inventory(int p_periode_int, string p_ptlokasi, string p_iddata, string p_posted, string p_periode_str, string p_userid, int p_glyear, int p_glmonth);
