-- Purpose: Expose section NORMAL_POSISI as POSISI in ACCT_REPORT_ENGINE_V1.GET_REPORT
-- output so the client can compute cross-section result lines (Laba Kotor/Usaha/etc.).
...
END ACCT_REPORT_ENGINE_V1;]';
    ...
    DBMS_OUTPUT.PUT_LINE('EXPOSED POSISI IN ACCT_REPORT_ENGINE_V1.GET_REPORT');
END;
/
