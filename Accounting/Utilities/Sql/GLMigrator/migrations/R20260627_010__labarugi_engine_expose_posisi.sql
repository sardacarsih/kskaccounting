-- Rollback: restore ACCT_REPORT_ENGINE_V1.GET_REPORT without the POSISI column
-- (matches the V20260627_008 display-level body).
...
END ACCT_REPORT_ENGINE_V1;]';
    ...
    DBMS_OUTPUT.PUT_LINE('ROLLED BACK POSISI COLUMN FROM ACCT_REPORT_ENGINE_V1');
END;
/
