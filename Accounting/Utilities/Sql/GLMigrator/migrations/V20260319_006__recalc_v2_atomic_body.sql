-- Purpose: Upgrade ACCT_RECALLCULATIONS_V2 body to atomic processing (no per-row commit).
-- Date: 2026-03-19
...
END ACCT_RECALLCULATIONS_V2;]';
    ...
    DBMS_OUTPUT.PUT_LINE('REPLACED PACKAGE BODY ACCT_RECALLCULATIONS_V2 (atomic mode)');
END;
/
