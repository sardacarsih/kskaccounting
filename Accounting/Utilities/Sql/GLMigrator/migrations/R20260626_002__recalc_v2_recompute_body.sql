-- Purpose: Rollback ACCT_RECALLCULATIONS_V2 to the previous additive atomic body
--          (single ReCalcByJurnalID entrypoint). Restores pre-recompute behaviour.
-- Date: 2026-06-26
        ...
        FOR recData IN (
            ...
            FOR recDataSaldo IN (
                ...
                ApplyMutasiByMonth(
                    ...
                    p_TAHUN => p_TAHUN,
                    p_BULAN => p_BULAN,
                    p_KODEACC => recDataSaldo.KODEACC,
                    p_DEBET => recData.DEBET,
                    p_KREDIT => recData.KREDIT
                );
...
END ACCT_RECALLCULATIONS_V2;]';
    ...
    DBMS_OUTPUT.PUT_LINE('ROLLED BACK ACCT_RECALLCULATIONS_V2 to additive atomic body');
END;
/
