-- Purpose: Roll back the atomic Tutup Tahun changes by restoring the prior package definitions:
--   * ACCT_JURNAL_CLOSING_V2 as defined in V20260701_002 (5-arg JURNAL_CLOSING, always commits).
--   * ACCT_CLOSING_YEAR_V2 as defined in V20260701_003 (unconditional balance check, no explicit commit).
-- Date: 2026-07-01
...
END ACCT_JURNAL_CLOSING_V2;]';
    ...
    DBMS_OUTPUT.PUT_LINE('ROLLED BACK ACCT_JURNAL_CLOSING_V2 TO V20260701_002 DEFINITION');
END;
/
