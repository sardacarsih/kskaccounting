-- Purpose: Bypass legacy COA update/delete triggers when save path uses async recalc.
-- Date: 2026-03-20
...
ALTER TRIGGER UPDATE_COA_FROM_UPDATE ENABLE;
/
...
ALTER TRIGGER UPDATE_COA_FROM_DELETE ENABLE;
/
