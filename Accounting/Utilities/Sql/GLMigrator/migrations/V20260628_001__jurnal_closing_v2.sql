-- Purpose: Add new ACCT_JURNAL_CLOSING_V2 package that calculates net profit/loss using ACCT_REPORT_ENGINE_V1
-- Date: 2026-06-28
...
CREATE OR REPLACE PACKAGE BODY ACCT_JURNAL_CLOSING_V2 AS
    ...
    BEGIN
        ...
        IF p_jurnalid IS NOT NULL THEN
            ACCT_RECALLCULATIONS.ReCalcByNoJurnalID(p_IDDATA, p_bulan, p_tahun, p_jurnalid, sPeriode, p_userid);
        END IF;
...
END ACCT_JURNAL_CLOSING_V2;]';
    ...
    DBMS_OUTPUT.PUT_LINE('CREATED PACKAGE ACCT_JURNAL_CLOSING_V2');
END;
/
