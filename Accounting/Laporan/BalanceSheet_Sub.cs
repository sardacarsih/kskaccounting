...
{
    public partial class BalanceSheet_Sub : DevExpress.XtraReports.UI.XtraReport
    {
        public BalanceSheet_Sub()
        {
            InitializeComponent();
        }
        DataSet DSSubRL;
        ...
        private void tableCell16_PreviewMouseMove(object sender, PreviewMouseEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.Brick.Text != "-" && string.IsNullOrEmpty(e.Brick.Text) == false)
                {
                    ...
                    else
                    {
                        ...
                        detailReport.DataSource = DSSubRL;
                        detailReport.Parameters["SUB"].Value = SUB;
                        detailReport.Parameters["PBULAN"].Value = pbulan;
                        detailReport.Parameters["PTAHUN"].Value = ptahun;
                        detailReport.Parameters["BULAN"].Value = bulan;
