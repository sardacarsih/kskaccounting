    ...
    public partial class FrmAkunEF_Luas : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void ConfigureResponsiveLayout()
        {
            ...
            headerLayout = CoaHeaderLayout.Apply(
                ...
                sbadd, sbubah, sbhapus, sbexport, null, refreshManualButton,
        ...
        private void OnDetailClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Group == "G")
                {
                    DataSet DSSubRL = LaporanServices.ViewAccountingReportDrillDown(iddata, pbulan, ptahun, "NERACA", 0, kode);
